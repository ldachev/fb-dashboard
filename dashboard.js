...
function renderMarketSummary(companies) {
  ...
  document.getElementById("market-summary").textContent =
    `This peer set frames Givaudan's market from ingredient creation through fragrance brands and beauty retail. The ingredient suppliers show the closest strategic comparison because they compete on formulation expertise, customer relationships, and operating discipline, while the beauty and fragrance brands show how demand is moving at the consumer end of the value chain. The most attractive companies combine steady sales growth with healthy margins and manageable leverage, while weaker profiles depend more heavily on turnaround execution or consumer-cycle recovery. Overall, the market favors businesses that can translate innovation and brand demand into consistent profits rather than growth alone.`;
